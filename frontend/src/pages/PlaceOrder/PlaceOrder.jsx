...
const PlaceOrder = () => {
    ...
    useEffect(() => {
        console.log("Current token in useEffect:", token);
        if (!token) {
    ...
    return (
        <form onSubmit={placeOrder} className='place-order'>
            ...
            <div className="place-order-right">
                ...
                <button className='place-order-submit' type='submit' disabled={isSubmitting}>
                    {isSubmitting ? "Processing..." : payment === "cod" ? "Place Order" : "Proceed To Payment"}
                </button>
            </div>
        </form>
    );
